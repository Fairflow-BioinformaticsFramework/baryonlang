...
def main():
    ...
    usage_str = ' '.join([f'\033[93m<workdir>{RESET}', f'\033[93m<genome>{RESET}', f'\033[93m<scratch>{RESET}', f'\033[92m<bamsave>{RESET}'])
    ...
    if args['bamsave'] not in ['true', 'false']:
        errors.append(f"""Invalid value for bamsave: {args["bamsave"]}. Allowed: ['true', 'false']""")
